...
classifier = cv2.CascadeClassifier(r"C:/Users/hriti/OneDrive/Desktop/face detection/face detection/haarcascade_frontalface_default.xml")

model = load_model(r"C:/Users/hriti/OneDrive/Desktop/face detection/face detection/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['hrishabh', 'hritik', 'vishwajit']
    return labels[pred]
